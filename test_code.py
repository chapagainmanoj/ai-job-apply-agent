...
class ClaudeResumeJobApplicationSystem:
...
# Usage example with Claude integration
def main():
    """Example usage of the Claude-powered system"""

    # Initialize the system with your Anthropic API key
    API_KEY = "your-anthropic-api-key-here"  # Replace with your actual API key
    system = ClaudeResumeJobApplicationSystem(
        api_key=API_KEY,
